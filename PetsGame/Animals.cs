...
namespace PetsGame
{
    ...
    class Animals : INotifyPropertyChanged
    {
        ...
        void ChangeToType(PetType type)
        {
            ...
            else if (type == PetType.Hamster)
            {
                ...
                DailyHappy = 0;
                Special = "+10 ♥\n-1 Day";
                ImageSource = "../Images/hamster.png";
